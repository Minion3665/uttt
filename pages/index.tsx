        ...
        <div className={Styles.grid + (winner ? " " + Styles[winner] : "")}>
            {grid.map((row, rowIndex) => (
                <>
                    ...
                    return <NoughtsAndCrosses key={rowIndex.toString() + " " + colIndex} highlight={!winner && !subgridWinner && playable}  winner={subgridWinner} grid={subgrid} turn={turn} onMove={onMove} colorblind={colorblind} />
                    })}
                    <br/>
                    </>
                )
